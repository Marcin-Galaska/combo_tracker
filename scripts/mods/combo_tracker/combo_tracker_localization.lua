...
return {
	...
	combo_tracker_widget_frame_opacity_desc = {
		en = "Opacity of possible frame attacks' icons."
	},
	combo_tracker_widget_frame_R = {
		en = "Red"
	},
	combo_tracker_widget_frame_R_desc = {
		en = "Intensity of the colour red of possible frame attacks' icons."
	},
	combo_tracker_widget_frame_G = {
		en = "Green"
	},
	combo_tracker_widget_frame_G_desc = {
		en = "Intensity of the colour green of possible frame attacks' icons."
	},
	combo_tracker_widget_frame_B = {
		en = "Blue"
	},
	combo_tracker_widget_frame_B_desc = {
		en = "Intensity of the colour blue of possible frame attacks' icons."
	},
